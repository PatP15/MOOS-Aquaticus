...
nsplug meta_vehicle.moos targ_$VNAME1.moos -f WARP=$TIME_WARP  VTYPE=KAYAK \
   VNAME=$VNAME1      START_POS=$START_POS1  SHORE=$SHORE      VGROUP=red  \
   VPORT="9001"       SHARE_LISTEN="9301"    

nsplug meta_vehicle.bhv targ_$VNAME1.bhv -f VNAME=$VNAME1 START_POS=$START_POS1 


nsplug meta_vehicle.moos targ_$VNAME2.moos -f WARP=$TIME_WARP  VTYPE=KAYAK \
   VNAME=$VNAME2      START_POS=$START_POS2   SHORE=$SHORE     VGROUP=blue \
